...
from ..async_io import save_file_from_stream_async, hash_file_async, delete_file_async
...
class StreamingUploadHandler:
    ...
    async def process_upload_stream(
        ...
        try:
            ...
            # Process the file
            from ..document_processor import get_doc_processor
...
class ChunkedFileReader:
    ...
    async def read_chunks(self) -> AsyncIterator[bytes]:
        """Read file in chunks"""
        from ..async_io import stream_file_async
